...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card my-4">
                <div class="bg-green card-header text-white"><?php echo e(__('Register')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" <?= (null != old('is_subscribed')) ? 'checked' : ' ' ?> id="is_subscribed" name="is_subscribed">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-dark bg-green  border border-none text-white ">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/team1/farm-fresh/resources/views/auth/register.blade.php ENDPATH**/ ?>