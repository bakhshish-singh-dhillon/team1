            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="static-page-head">
                        <img src="images/privacy.jpg" alt="Privacy policy">
                        <h1>Privacy Policy</h1>
                    </div>
                    <h2 class="mt-4">Introduction</h2>
                    <p>At Farm Fresh we value your privacy and the importance of safeguarding your data. This Privacy
                        Policy describes our privacy practices for the activities set out below. As per your rights, we
                        inform you how we collect, store, access, and otherwise process information relating to
                        individuals.
                        In this Policy, "Personal Data" refers to any information that on its own, or in combination
                        with other available information, can distinguish an individual.</p>
                    <p>We are committed to protecting your privacy in accordance with the highest level of privacy
                        regulation. As such,we follow the obligations under</p>

                    <ul class='li_size'>
                        <li>
                            Canada's Personal Information Protection and Electronic Documents Act and the applicable
                            provincial legislations
                        </li>
                        <li>
                            The EU's General Protection Data Regulation
                        </li>
                        <li>
                            Brazil's Data Protection Legislation
                        </li>
                        <li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/team1/farm-fresh/resources/views/privacy.blade.php ENDPATH**/ ?>