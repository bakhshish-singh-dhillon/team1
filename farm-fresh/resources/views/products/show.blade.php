    ...
    <div id="detail">
        <div class="max-container py-4">
            <div class="row">
                        ...
                        <tr>
                            ...
                            <td id="quantity" class="d-flex user-select-none">
                                <form class="d-flex" action="{{ route('add-to-cart', ['product' => $product->id]) }}"
                                    ...
                                    @else
                                        <button type="submit" class="btn" data-toggle="tooltip" data-placement="bottom"
                ...
                <div>
                    <div class="tab">
                        <button class="tablinks active" onclick="changeTab(event, 'Description')" data-toggle="tooltip"
                            data-placement="bottom" title="Description">Description</button>
                        <button class="tablinks" onclick="changeTab(event, 'Additional Info')" data-toggle="tooltip"
                            data-placement="bottom" title="Additional Info">Additional Info</button>
                    </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="">
                                            <form action="{{ route('store-product-review', ['product' => $product->id]) }}"
                                                method="POST" id="add_review_form">
                                                @csrf
                                                ...
                                                <table class="w-100">
                                                    <tr>
                                                        <td class="px-2 w-25"><label for="sel1">Rate the
                                                                product:</label></td>
                                                        <td class="py-2"><select name="rating" class="form-control"
                                                                id="sel1">
