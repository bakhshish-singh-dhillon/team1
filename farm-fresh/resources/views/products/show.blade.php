                                ...
                                @foreach ($reviews as $review)
                                    <div>
                                        ...
                                        <p class="my-2"><select name="rating" class="form-control rating-static">
                                                <option value="1"
                                                    {{ $review->rating == 1 ? 'selected="selected"' : '' }}>
                                                    1</option>
                                                <option value="2"
                                                    {{ $review->rating == 2 ? 'selected="selected"' : '' }}>2</option>
                                                <option value="3"
                                                    {{ $review->rating == 3 ? 'selected="selected"' : '' }}>3</option>
                                                <option value="4"
                                                    {{ $review->rating == 4 ? 'selected="selected"' : '' }}>4</option>
                                                <option value="5"
                                                    {{ $review->rating == 5 ? 'selected="selected"' : '' }}>5</option>
                                            </select></p>
