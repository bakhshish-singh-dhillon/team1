            ...
            <div class="row">
                <div class="col-md-3 left-part">
                    ...
                    <div class="category-list capitalization">
                        <ul class="p-0">
                            <li>
                                <a href="{{ route('products', []) }}" class="my-2" data-toggle="tooltip"
                                    data-placement="bottom" title="All Products"><strong>All Products</strong></a>
                            </li>
                ...
                <div class="col-md-9">
                    <div class="title ">{{ $title }} ({{ $products->total() }})
                        <div class="float-right">
                            <form action="{{ route('products-by-search', []) }}" method="get" autocomplete="off"
                                novalidate>
                                @csrf
                        ...
                        @foreach ($products as $prod)
                            <div class="col-md-4 my-2">
                                <div class="card product-item">
                                    <img class="card-img-top" src="{{ $images_path . $prod->images()->first()->url }}"
                                        alt="{{ $prod->images()->first()->url }}">
                                    <div class="card-body">
