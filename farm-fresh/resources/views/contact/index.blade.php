                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="Your name" data-toggle="tooltip" data-placement="bottom" title="Your Name">
                                @error('name')
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="email" id="email"
                                    placeholder="Your Email" data-toggle="tooltip" data-placement="bottom"
                                    title="Your Email">
                                @error('email')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="phone" id="phone"
                                    placeholder="Phone #" data-toggle="tooltip" data-placement="bottom" title="Phone">
                                @error('phone')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <textarea class="form-control" name="message" id="message" cols="30" rows="4"
                                    placeholder="Write your message" data-toggle="tooltip" data-placement="bottom" title="Write your message"></textarea>
                                @error('message')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
