            ...
            <div>
                <form method="get" action="/admin/categories/search">
                    <div class="btn-group mx-2">
                        @csrf
                        <input class="form-control search-bar" type="search" name="search" placeholder="Search by name or id"
                            value="{{ app('request')->input('search') }}" data-toggle="tooltip" data-placement="bottom"
                            title="Search" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-primary mx-2" id="edit_category"
                                        data-bs-toggle="modal" data-bs-target="#categoryModal" data-bs-whatever="Edit"
                                        data-bs-id="{{ $cat->id }}" data-bs-name="{{ $cat->name }}"
                                        data-bs-parent="{{ null == $cat->parent ? null : $cat->parent->id }}"><i
                                            class="fa-solid fa-pencil" data-toggle="tooltip" data-placement="bottom"
                                            title="Edit"></i></button>
                                    ...
                                    <form method="post" action="{{ route('cat-delete', ['category' => $cat->id]) }}">
                                        ...
                                        <button class="btn btn-danger"
                                            onclick="return confirm('Are you sure you want to delete this category?')"><i
                                                class="fa-solid fa-trash-can" data-toggle="tooltip" data-placement="bottom"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header blue-bg">
                            ...
                            <button type="button" class="no-style white-text" data-bs-dismiss="modal"><i
