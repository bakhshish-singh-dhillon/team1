                    ...
                    <td>
                        <div class="">
                            <form method="post" action="{{ route('user-delete', ['user' => $user->id]) }}">
                                ...
                                <button class="btn btn-danger" onclick="return confirm('Are you sure you want to deactivate this user?')"><i class="fa-solid fa-ban" data-toggle="tooltip" data-placement="bottom" title="Delete"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
