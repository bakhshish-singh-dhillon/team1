                    ...
                    <div class="content">
                        ...
                        <div>
                            <form method="get" action="{{ route('products-by-search', []) }}">
                                <div>
                                    @csrf
                                    <input class="form-control w-96" type="search" name="search" data-toggle="tooltip"
                                        data-placement="bottom" title="Search product" placeholder="Search products"
            ...
            <div id="category">
                ...
                <div class="row py-4">
                    <div class="col-md-3 text-center">
                        <a href="{{ route('products', []) }}" class="my-2" data-toggle="tooltip" data-placement="bottom"
                            title="All Products">
                    ...
                    <div class="col-md-3 text-center capitalization">
                        <a href="{{ route('products-by-category', ['category' => $categories[1]->id]) }}"
                            data-toggle="tooltip" data-placement="bottom" title="{{ $categories[1]->name }}">
                    ...
                    <div class="col-md-3 text-center capitalization">
                        <a href="{{ route('products-by-category', ['category' => $categories[2]->id]) }}"
                            data-toggle="tooltip" data-placement="bottom" title="{{ $categories[2]->name }}">
                    ...
                    <div class="col-md-3 text-center capitalization">
                        <a href="{{ route('products-by-category', ['category' => $categories[0]->id]) }}"
                            data-toggle="tooltip" data-placement="bottom" title="{{ $categories[0]->name }}">
