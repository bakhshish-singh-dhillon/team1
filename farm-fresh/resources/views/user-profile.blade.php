                        ...
                        <form method="POST" action="{{ route('user-detail-update', ['user' => $user->id]) }}">
                            ...
                            <div class="row mb-3">
                                <label for="first_name"
                                    class="col-md-4 col-form-label text-md-start">{{ __('First name') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="last_name"
                                    class="col-md-4 col-form-label text-md-start">{{ __('Last name') }}</label>
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                            <?= null != $user->is_subscribed ? 'checked' : ' ' ?> id="is_subscribed"
                                            name="is_subscribed">
                    ...
                    <div class="col-md-12 my-2 ">
                        <div class="card product-item">
                            ...
                            <div id="address" class="collapse">
                                ...
                                <a href="{{ route('user-profile-addresses', ['user' => $user->id]) }}"
                                    class="my-2"><strong>Add/Update Addresses</strong></a>
                            </div>
                        </div>
                    </div>
